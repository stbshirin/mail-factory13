...
export const translations = {
  bn: {
    ...
    sell_new_gmail: 'নতুন জিমেইল (New Gmail)',
    sell_old_gmail: 'পুরাতন জিমেইল (Old Gmail)',
    sell_fresh: 'নতুন জিমেইল (Fresh)',
    sell_recovery: 'রিকভারি জিমেইল',
    sell_aged: 'পুরাতন জিমেইল (Aged)',
    sell_add_row: '+ আরও অ্যাকাউন্ট যোগ করুন',
    sell_paste_multiple: 'একসাথে পেস্ট করুন',
  ...
  en: {
    ...
    sell_new_gmail: 'New Gmail',
    sell_old_gmail: 'Old Gmail (Aged)',
    sell_fresh: 'New Gmail (Fresh)',
    sell_recovery: 'Recovery Gmail',
    sell_aged: 'Old Gmail (Aged)',
    sell_add_row: '+ Add Another Account',
    sell_paste_multiple: 'Paste Multiple',
